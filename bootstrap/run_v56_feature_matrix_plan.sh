...
OUTPUT_ROOT="${4:-/content/drive/MyDrive/eeg-ds004752/artifacts/v56_feature_matrix_plan}"
PROFILE="${5:-t4_safe}"
...
cat <<MSG
[V5.6 Tranche 2.2] Feature-matrix plan starting
  repo_root: ${REPO_ROOT}
  gate0_run: ${GATE0_RUN}
...
[V5.6 Tranche 2.2] Feature-matrix plan finished
