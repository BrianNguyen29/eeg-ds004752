...
| Phase 1 final comparator runner | Technical Spec, Annex, Dossier | `src/phase1/final_comparator_runner.py` | `configs/phase1/final_comparator_runner.json` | `tests/unit/test_phase1_final_comparator_runner.py` | Claim-closed feature-matrix comparator runner. Consumes `final_feature_matrix.csv`, writes logits/metrics/manifests/runtime leakage logs for comparators that are valid from that matrix, and blocks A2d Riemannian unless final covariance/tangent inputs exist. |
| Phase 1 final A2d covariance/tangent runner | Technical Spec, Annex, Dossier | `src/phase1/final_a2d_runner.py` | `configs/phase1/final_a2d_runner.json`, `configs/models/riemannian_a2d.yaml` | `tests/unit/test_phase1_final_a2d_runner.py` | Claim-closed A2d runner. Uses the final feature-matrix row index as row/provenance contract, extracts covariance from EDF payloads, writes A2d logits/metrics/manifests/runtime leakage logs, and keeps claims closed. |
...
| Final comparator runner | `src/phase1/final_comparator_runner.py`, `configs/phase1/final_comparator_runner.json` | Phase 1 final comparator output manifests and runtime leakage logs | Runs claim-closed deterministic feature-matrix comparators from `final_feature_matrix.csv` and writes output manifests. A2d is explicitly blocked from this input until a covariance/tangent final runner exists. |
| Final A2d covariance/tangent runner | `src/phase1/final_a2d_runner.py`, `configs/phase1/final_a2d_runner.json` | Phase 1 final A2d output manifest and runtime leakage log | Uses the final row index and EDF payloads to compute covariance/tangent A2d outputs. It can resolve the A2d missing-output engineering blocker for downstream reconciliation but remains non-claim. |
...
| Phase 1 final comparator runner | `run_phase1_final_comparator_runner` | `phase1_final_comparator_runner_inputs.json`, `phase1_final_comparator_runner_summary.json`, `phase1_final_comparator_runner_report.md`, `phase1_final_comparator_runner_source_links.json`, `phase1_final_comparator_runner_input_validation.json`, `phase1_final_comparator_runtime_leakage_audit.json`, `phase1_final_comparator_completeness_table.json`, `phase1_final_comparator_runner_claim_state.json`, plus `final_logits/`, `final_subject_level_metrics/`, `runtime_leakage_logs/`, `fold_logs/`, `comparator_output_manifests/`, and `blocked_comparators/` |
| Phase 1 final A2d covariance/tangent runner | `run_phase1_final_a2d_runner` | `phase1_final_a2d_runner_inputs.json`, `phase1_final_a2d_runner_summary.json`, `phase1_final_a2d_runner_report.md`, `phase1_final_a2d_runner_source_links.json`, `phase1_final_a2d_runner_input_validation.json`, `phase1_final_a2d_covariance_validation.json`, `a2d_final_covariance_manifest.json`, `a2d_final_tangent_manifest.json`, `phase1_final_a2d_completeness_patch.json`, `phase1_final_a2d_claim_state.json`, plus `final_logits/A2d_riemannian_final_logits.json`, `final_subject_level_metrics/A2d_riemannian_subject_level_metrics.json`, `runtime_leakage_logs/A2d_riemannian_runtime_leakage_audit.json`, `fold_logs/`, and `comparator_output_manifests/A2d_riemannian_output_manifest.json` |
